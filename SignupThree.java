...
public class SignupThree extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            if (c4.isSelected()) {
                facility.append("Email and SMS Alerts ");
            }
            if (c5.isSelected()) {
            ...
            try {
                if (accountType == null) {
                    ...
                    String query1 = "insert into signupThree values('" + formno + "','" + accountType + "','" + cardnumber + "','" + pinnumber + "','" + facility.toString().trim() + "')";
                    conn.s.executeUpdate(query1);
                    String query2 = "insert into llogin values('" + formno + "','" + cardnumber + "','" + pinnumber + "')";
